    ...
    <main className="min-h-dvh px-4 py-10 text-white md:px-8">
      <div className="mx-auto w-full max-w-4xl px-4 pb-14 pt-10 sm:px-6 md:px-12">
        <header className="max-w-2xl">
          ...
          <p
            className="mt-2 text-2xl italic text-white/90"
            style={{ fontFamily: "var(--font-nostalgic)" }}
          >
            we&apos;ll build it.
          </p>
          <p className="mt-4 text-sm text-white/75">
            Explore different starting points for your custom jewelry piece. We&apos;ll guide you step-by-step from inspiration to a ready-to-build concept.
          </p>
        </header>
